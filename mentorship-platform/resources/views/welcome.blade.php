                                ...
                                <div class="flex-1">
                                    ...
                                    <ul class="mt-4 space-y-3 text-gray-400">
                                        <li class="flex items-center">
                                            <span class="text-sm">• Create your profile</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="text-sm">• Connect with mentors/startups</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="text-sm">• Schedule sessions</span>
                                        </li>
                                        <li class="flex items-center">
                                            <span class="text-sm">• Grow together</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mt-6">
